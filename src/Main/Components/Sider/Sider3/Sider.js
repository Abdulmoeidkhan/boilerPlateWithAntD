        ...
        <ThemeContext.Consumer>
            {colorsState =>
                <Layout style={{ minHeight: '100vh' }} >
                    <Layout className="site-layout with-right-icons">
                        <Header className="header" style={{ backgroundColor: colorsState.colors.color1, color: colorsState.colors.color3 }}>
                            ...
                            <div className="nav-right2-class">
                                <style jsx="true">
                                    {`
                                        .nav-right2-class{
                            ...
                            <div className="nav-right-class">
                                <Menu style={{ backgroundColor: colorsState.colors.color1, color: colorsState.colors.color3 }} mode="horizontal" defaultSelectedKeys={["4"]}>
